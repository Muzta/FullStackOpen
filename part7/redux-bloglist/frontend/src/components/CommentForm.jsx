  ...
  return (
    <div>
      <form id="comment-form" onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm ml-4 px-5 py-1.5 text-center"
        >
          Add comment
        </button>
      </form>
